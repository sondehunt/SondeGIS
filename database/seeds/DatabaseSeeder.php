...
class DatabaseSeeder extends Seeder
{
    ...
    {
        factory(ApproveToken::class, 3000)->create()->each(static function (ApproveToken $approve_token) {
        ...
        factory(ApproveToken::class, 10000)->create()->each(static function (ApproveToken $approve_token) {
